...
class rlListings
{
    ...
    public function getListings($category_id = false, $order = false, $order_type = 'ASC', $start = 0, $limit = 10, $listing_type = false)
    {
        ...
        } elseif ($order && isset($sorting[$order]) && is_array($sorting[$order])) {
        ...
        foreach ($listings as &$listing) {
            ...
            $listingFields = is_array($shortFormFields) ? $shortFormFields : array();
    ...
    public function getShortDetails($id, $plan_info = false)
    {
        ...
        foreach ($fields as $idx => &$field) {
            ...
            $fieldValue = isset($listing[$field['Key']]) ? $listing[$field['Key']] : '';
