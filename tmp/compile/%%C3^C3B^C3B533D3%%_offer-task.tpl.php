<?php /* Smarty version 2.6.31, created on 2025-07-12 17:21:05
         compiled from /home/gmoplus/mobil.gmoplus.com/templates/services_rainbow/components/offer-task/_offer-task.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'pageUrl', '/home/gmoplus/mobil.gmoplus.com/templates/services_rainbow/components/offer-task/_offer-task.tpl', 65, false),)), $this); ?>
<!-- Popup interface -->
    ...
    <div class="mt-4">
        [%if listings%]
            <select class="w-100 offer-tasks-selector">
                <option value=""><?php echo $this->_tpl_vars['lang']['service_select_from_my_tasks']; ?>
</option>
                [%for listings%]
                    <option value="[%:ID%]">[%:listing_title%]</option>
                [%/for%]
            </select>
            <input type="button" class="offer-task-button w-100 mt-2" value="<?php echo $this->_tpl_vars['lang']['service_offer_selected_task']; ?>
" />

            <?php if ($this->_tpl_vars['post_task_page_key']): ?>
                <div class="text-center mt-3 mb-3"><?php echo $this->_tpl_vars['lang']['or']; ?>
</div>
            <?php endif; ?>
        [%/if%]

        <?php if ($this->_tpl_vars['post_task_page_key']): ?>
            <a class="button button-transparent w-100" target="_blank" href="[%:add_listing_url%]"><?php echo $this->_tpl_vars['lang']['service_offer_new_task']; ?>
</a>
        <?php endif; ?>
    </div>
</div>
...
<script>
rlConfig['show_call_owner_button'] = <?php echo $this->_tpl_vars['config']['show_call_owner_button']; ?>
;
<?php echo '
